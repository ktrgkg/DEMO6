...
function updateDataFromExcel($filePath, $namParam, $thangParam) {
    ...
    if ($stmt) {
        ...
        for ($row = 2; $row <= $highestRow; $row++) {
            ...
            if ($mst_kh === null) {
                $mst_kh = ''; // hoặc giá trị mặc định khác nếu cần
            }
            ...
            if ($giacuoc === null) {
                $giacuoc = ''; // hoặc giá trị mặc định khác nếu cần
            }
            ...
            if ($ctv_kinhdoanh === null) {
                $ctv_kinhdoanh = ''; // hoặc giá trị mặc định khác nếu cần
            }
            ...
            if ($diaban === null) {
                $diaban = ''; // hoặc giá trị mặc định khác nếu cần
            }
